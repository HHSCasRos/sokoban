...
public class SpelerTest {
    ...
    public void Doos_And_Player_SHOULD_Not_Move_WHEN_Doos_Pushed_Onto_Tile_Thats_Not_In_Field() {
        ...
        Coordinaat C_01 = new Coordinaat(0,1);      crds[2]= C_01;        Tile t_01 = new Veld(C_01);        tiles[2] = t_01;
        Coordinaat C_11 = new Coordinaat(1,1);      crds[3]= C_11;        Tile t_11 = new Veld(C_11);        tiles[3] = t_11;
        
        dh.fillField(tiles, 2);
    ...
    public void Doos_And_Player_SHOULD_Not_Move_WHEN_Doos_Pushed_Onto_Tile_That_Contains_Doos(){
        ...
        Coordinaat C_13 = new Coordinaat(1,3);      crds[13]= C_13;        Tile t_13 = new Veld(C_13);       tiles[13] = t_13;
        ...
        Doos D_1 = new Doos(new Coordinaat(1,1),dh);
        Doos D_2 = new Doos(new Coordinaat(2,1),dh);
